...
export const PREFS_APPS = ['hub', 'finance', 'notas', 'planner', 'fit', 'study', 'recipes', 'prateleira'];
export const PREFS_TOURS = ['hub', 'finance', 'notas', 'planner', 'fit', 'study', 'recipes', 'mini', 'prateleira', 'julioel'];

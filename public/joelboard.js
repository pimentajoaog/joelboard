...
(function () {
      ...
      return {
        ...
        data: {
          ...
          itens: [
            ...
            { id: 'ghost-i14', notaId: 'ghost-n4', ordem: 2, texto: 'Reservas / e-tickets', marcavel: true, feito: false, tipo: '' },
            { id: 'ghost-i15', notaId: 'ghost-n4', ordem: 3, texto: 'Mala', marcavel: false, feito: false, tipo: 'g' },
            { id: 'ghost-i16', notaId: 'ghost-n4', ordem: 4, texto: 'Roupas', marcavel: true, feito: false, tipo: '' },
            { id: 'ghost-i17', notaId: 'ghost-n4', ordem: 5, texto: 'Carregador', marcavel: true, feito: false, tipo: '' },
            { id: 'ghost-i18', notaId: 'ghost-n4', ordem: 6, texto: 'Higiene', marcavel: true, feito: false, tipo: '' },
            { id: 'ghost-i19', notaId: 'ghost-n4', ordem: 7, texto: 'Casa', marcavel: false, feito: false, tipo: 'g' },
            { id: 'ghost-i20', notaId: 'ghost-n4', ordem: 8, texto: 'Lixo', marcavel: true, feito: false, tipo: '' },
            { id: 'ghost-i21', notaId: 'ghost-n4', ordem: 9, texto: 'Plantas', marcavel: true, feito: false, tipo: '' },
            { id: 'ghost-i22', notaId: 'ghost-n4', ordem: 10, texto: 'Tomadas', marcavel: true, feito: false, tipo: '' },
  ...
  function jbAcctLabel(nome, icone, em) {
    nome = String(nome || '').trim();
    if (nome) return ((jbNormProfileIcon(icone) || '👤') + ' ' + nome).trim();
  ...
  function acctLabel() { return jbAcctLabel(profileName(), profileIcon(), email()); }
  ...
  function renderProfileIcons() {
    ...
    var html = PROFILE_ICONS.map(function (ic) {
    ...
    ['jbProfileIcons', 'hubProfileIcons'].forEach(function (id) {
      var el = document.getElementById(id);
      if (el) el.innerHTML = html;
    });
    ['jbProfilePreview', 'hubProfilePreview'].forEach(function (id) {
      var prev = document.getElementById(id);
      if (prev) prev.textContent = cur || '👤';
    });
    ['jbProfileCustom', 'hubProfileCustom'].forEach(function (id) {
  ...
  function prepareProfileEditor() {
    ...
    var hubName = document.getElementById('hubProfileNameIn');
    if (hubName && document.activeElement !== hubName) hubName.value = profileName();
    renderProfileIcons();
  }
  function saveProfileValues(nome, icone) {
    nome = String(nome || '').trim();
    if (!nome) { jbToast('Escolha um nome'); return null; }
    var p = writeProfile(nome, icone || profileDraftIcon || profileIcon());
  ...
  function saveProfile() {
    ...
    var p = saveProfileValues(nameEl && nameEl.value, profileDraftIcon || profileIcon());
    if (!p) return;
